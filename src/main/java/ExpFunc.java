public class ExpFunc implements IFuncOnSegment{
    ...
    public ExpFunc(double koefA, double koefB, double beginOfSegment, double endOfSegment){
        this.koefA = koefA;
        this.koefB = koefB;
